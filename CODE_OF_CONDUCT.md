...
We pledge to make this project welcoming, safe, and equitable for all.
...
When an incident does occur, it is important to report it promptly. To report a possible violation, open a private report at <https://github.com/savonrb/savon/security/advisories/new>. While GitHub names this channel for security advisories, it gives you a confidential way to reach the maintainers and is the channel we use for Code of Conduct reports as well. Please prefix the report title with `[Code of Conduct]` so we can route it correctly.
