...
* Feature: [#572](https://github.com/savonrb/savon/pull/572) Add an `all_operations` method to `Savon::Model` that automatically adds all available operations to the model.
