...
describe Savon::XS::ComplexType do
  ...
  specify 'all/element' do
    ...
    expect(all).to be_a(Savon::XS::All)
  ...
  specify 'complexContent/extension/sequence/element' do
    ...
    expect(complex_content).to be_a(Savon::XS::ComplexContent)

    extension = complex_content.children.first
    expect(extension).to be_a(Savon::XS::Extension)
    ...
    expect(sequence_elements[0]).to be_a(Savon::XS::Element)
    expect(sequence_elements[0].name).to eq('Description')

    expect(sequence_elements[1]).to be_a(Savon::XS::Element)
    ...
    expect(sequence_elements[2]).to be_a(Savon::XS::Element)
  ...
  specify 'complexType/sequence/element/simpleType' do
    ...
    expect(elements[2].inline_type).to be_a(Savon::XS::SimpleType)
