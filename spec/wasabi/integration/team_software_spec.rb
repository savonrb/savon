...
describe Wasabi do
  context 'with: team_software.wsdl' do
    ...
    before do
      http_mock.fake_request(wsdl_url, 'team_software/team_software.wsdl')
      ...
      (0..3).each do |i|
        ...
        http_mock.fake_request(url, "team_software/team_software#{i}.xsd")
      end
    end
    ...
    it 'knows the operations' do
      ...
      operation = wsdl.operation(service, port, 'Login')
