...
class Savon
  ...
  def raise_initialization_error!
    raise InitializationError,
          ...
          "Savon.new(wsdl: '/Users/me/project/service.wsdl')                              # to use a local WSDL document\n" \
          "Savon.new(wsdl: 'http://example.com?wsdl')                                     # to use a remote WSDL document\n" \
          "Savon.new(endpoint: 'http://example.com', namespace: 'http://v1.example.com')  # if you don't have a WSDL document"
  end
