...
After instantiating a client, you can choose an authentication method to the requests.
...
Choose {Basic}[http://en.wikipedia.org/wiki/Basic_access_authentication] or {NTLM}[http://en.wikipedia.org/wiki/NTLM] according to your needs.
