...
{Documentation}[http://savon.rubiii.com/docs] | {Metrics}[http://getcaliper.com/caliper/project?repo=git://github.com/rubiii/savon.git]
...
For production, it is highly recommended to not use Savon::WSDL. Information about {how to disable the WSDL}[link:files/readme/wsdl_rdoc.html].
